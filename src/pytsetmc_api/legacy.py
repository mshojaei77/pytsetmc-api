...
def Get_Price_History(stock = 'خودرو', start_date = '1404-01-01', end_date='1403-01-01', ignore_date = False, adjust_price = False, show_weekday = False, double_date = False):
    """
...
def Get_RI_History(stock = 'خودرو', start_date = '1404-01-01', end_date='1403-01-01', ignore_date = False, show_weekday = False, double_date = False, alt = False):
    """
...
def Get_CWI_History(start_date = '1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_EWI_History(start_date = '1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = True, show_weekday = False, double_date = False):
    """
...
def Get_IntradayTrades_History(stock = 'وخارزم', start_date = '1404-09-15', end_date='1404-12-29', jalali_date = True, combined_datatime = False, show_progress = True):
    """
...
def Get_USD_RIAL(start_date = '1395-01-01', end_date='1404-12-29', ignore_date = False, show_weekday = False, double_date = False):
    # check date validity --------------------------------------------------------------------------------------------------------------
    if(not ignore_date):
        start_date = __Check_JDate_Validity__(start_date,key_word="'START'")
        if(start_date==None):
...
def Get_Queue_History(stock = 'وخارزم', start_date = '1404-09-15', end_date='1404-12-29', show_per_capita = True, show_weekday = False, double_date = False, show_progress = True):
    """
...
def Get_IntradayOB_History(stock = 'کرمان', start_date = '1404-08-01', end_date='1404-08-01', jalali_date = True, combined_datatime = False, show_progress = True):
    """
...
def Get_SectorIndex_History(sector = 'خودرو', start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, \
...
def Get_CWPI_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_EWPI_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_FFI_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_MKT1I_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_MKT2I_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_INDI_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_LCI30_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
...
def Get_ACT50_History(start_date='1395-01-01', end_date='1404-12-29', ignore_date = False, just_adj_close = False, show_weekday = False, double_date = False):
    """
